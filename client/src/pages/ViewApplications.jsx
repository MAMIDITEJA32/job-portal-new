...
const ViewApplications = () => {
  ...
  if (applicants.length === 0) return <div className='flex items-center justify-center h-[70vh]'>
            ...
            {applicants
              ...
              .map((applicant, index) => (
                <tr className="text-gray-700" key={index}>
                  ...
                  <td className="py-2 px-4 border-b max-sm:hidden">{applicant?.jobId?.title || 'Unknown'}</td>
                  <td className="py-2 px-4 border-b max-sm:hidden">{applicant?.jobId?.location || 'Unknown'}</td>
                  ...
                  <td className="py-2 px-4 border-b relative">
                    {applicant.status === "Pending" ? (
                      <div className="relative inline-block text-left group">
                        ...
                        <div className="z-10 hidden absolute left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
