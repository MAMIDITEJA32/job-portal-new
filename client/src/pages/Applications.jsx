...
const Applications = () => {
  ...
  console.log("User Applications:", userApplications); // Debugging
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {isEdit ? (
            ...
            <div className='flex gap-2'>
              <a className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg' href={userData.resume} target='_blank' download="resume.pdf">
                Download Resume
              </a>
            ...
            {userApplications?.length > 0 ? (
              userApplications.map((job, index) => (
                <tr key={index}>
                  ...
                  <td className='py-2 px-4 border-b max-sm:hidden'>{job.jobId?.location || 'Unknown'}</td>
